...
#### 1.2.3 Minimal Theme Settings 极简外观设定
...
### 1.2.1 如何在Obsidian中接入硅基流动？

### 1.2.2 步骤1：注册并获取API密钥
...
### 1.2.3 步骤2：配置Obsidian Copilot插件
